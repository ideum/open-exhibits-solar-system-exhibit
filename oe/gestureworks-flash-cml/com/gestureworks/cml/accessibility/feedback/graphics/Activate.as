package com.gestureworks.cml.accessibility.feedback.graphics {
	 ...
	 * @author Ken Willes
	 */
	public final class Activate extends MovieClip implements IFeedback {
		...
		public function Activate(renderContext:AccessibilityController) {
			super();
		...
		private function initGraphics():void {
			// will need to make this position dynamic
		...
		private function initLanguageStates():void {
			...
			_label.text = _prebuiltText.valueOf(PrebuiltText.INTRO_HELPER_TEXT); // get english default text
			// label states
			for (var j:int = 0; j < LanguageCode.Languages.length; j++) {
				...
				state["text"] = _prebuiltText.valueOf(PrebuiltText.INTRO_HELPER_TEXT);
