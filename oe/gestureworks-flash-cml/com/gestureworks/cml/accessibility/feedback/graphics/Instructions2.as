package com.gestureworks.cml.accessibility.feedback.graphics {
	 ...
	 * @author Ken Willes
	 */
	public final class Instructions2 extends Sprite implements IFeedback {
		
		private var _renderContext:AccessibilityController;
		private var _graphic:TwoFingerTap;
		private var _label:Text;
		private var _prebuiltText:PrebuiltText;
		
		public function Instructions2(renderContext:AccessibilityController) {
			super();
