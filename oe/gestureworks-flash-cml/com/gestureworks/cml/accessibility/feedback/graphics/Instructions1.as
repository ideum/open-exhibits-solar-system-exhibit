package com.gestureworks.cml.accessibility.feedback.graphics {
	 ...
	 * @author Ken Willes
	 */
	public final class Instructions1 extends Sprite implements IFeedback {
		
		private var _renderContext:AccessibilityController;
		private var _graphic:TapOrDoubleTap;
		private var _label:Text;
		private var _prebuiltText:PrebuiltText;
		
		public function Instructions1(renderContext:AccessibilityController) {
			super();
