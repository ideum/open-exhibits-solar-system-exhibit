package com.gestureworks.cml.accessibility.feedback.graphics {
	 ...
	 * @author Ken Willes
	 */
	public final class Instruction0 extends Sprite implements IFeedback {
		
		private var _renderContext:AccessibilityController;
		private var _graphic:SwipeLeftOrRight;
		private var _prebuiltText:PrebuiltText;
		
		public function Instruction0(renderContext:AccessibilityController) {
			super();
