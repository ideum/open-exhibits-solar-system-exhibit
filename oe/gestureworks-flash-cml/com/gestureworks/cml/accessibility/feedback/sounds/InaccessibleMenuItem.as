package com.gestureworks.cml.accessibility.feedback.sounds {
	...
	import acc.DunkSound;
	
	/**
	 * ...
	 * @author Ken Willes
	 */
	public final class InaccessibleMenuItem extends Sound implements IFeedback {
		
		private var _sound:DunkSound;
		private var _soundChannel:SoundChannel;
		
		public function InaccessibleMenuItem() {
			super();
			_sound = new DunkSound();
