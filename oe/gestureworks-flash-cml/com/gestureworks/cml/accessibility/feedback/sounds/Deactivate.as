package com.gestureworks.cml.accessibility.feedback.sounds {
	...
	import acc.DeactivateSound;
	
	/**
	 * ...
	 * @author Ken Willes
	 */
	public final class Deactivate extends Sound implements IFeedback {
		
		private var _sound:DeactivateSound;
		private var _soundChannel:SoundChannel;
		
		public function Deactivate() {
			super();
			_sound = new DeactivateSound();
