package com.gestureworks.cml.elements
{
	 ...
	 * @see GestureList
	 */ 
		public class TouchContainer extends TouchSprite implements IContainer, ICSS, IState, ISpeech
	{
		...
		/**
		 * Callback invoked on change in visibility
		 */
		public var notifyVisible:Function;
		
		/**
		 * Callback invoked on change in registerd interaction points
		 */
		public var notifyInteraction:Function;
		...
		override public function set visible(value:Boolean):void {
			super.visible = value;
			if (notifyVisible != null) {
				notifyVisible.call(null, this);
			}
		}
		 ...
		 * @inheritDoc
		 */
		override public function get pointArray():Vector.<PointObject> {
			if (super.pointArray.length && notifyInteraction != null) {
				notifyInteraction.call(null, this);
			}
			return super.pointArray;
		}
